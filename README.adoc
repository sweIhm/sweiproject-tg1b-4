...
This guide walks you through the process of creating a "base world" link:/understanding/REST[RESTful web service] with Spring.
...
`src/main/java/base/Greeting.java`
[source,java]
----
include::complete/src/main/java/base/Greeting.java[]
----
...
`src/main/java/base/GreetingController.java`
[source,java]
----
include::complete/src/main/java/base/GreetingController.java[]
----
